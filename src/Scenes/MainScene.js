class MainScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.boundaryLayer.setDepth(10);
        // Player

        this.player = this.physics.add.sprite(400, 700, "tilemap_sheet", 97).setScale(3.0);
        ...
        const enemyX = 400;
        const enemyY = 300;
        const newEnemy = new Ghoul(this, enemyX, enemyY);
    ...
    update(time, delta) {
        ...
        let playerTileX = Math.floor(this.player.x / (16*3));
        let playerTileY = Math.floor(this.player.y / (16*3));
        console.log("In general update: ", playerTileX, playerTileY);
    }
